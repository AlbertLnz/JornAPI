<?php 
namespace App\Annotations\Swagger\HourWorked\ShowHourdWorked;


class ShowHourWorkedAnnotations
{
    /**
     * @OA\Get(
     *     path="/hourworked?date={date}",
     ...
     * )
     */
    public function showHourWorkedAnnotations(){}
}